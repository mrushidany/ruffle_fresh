                ...
                <div class="row category-container text-center">
                    <div class="col-md-12">
                        ...
                        <form @submit="formSubmit" enctype="multipart/form-data">
                            <div class="row mr-4 ml-0" v-if="motorcycle">
                            ...
                            <div class="row mr-4 mt-4 ml-0" v-if="cashprize">
                                <label>Cash Prize File</label>
                            ...
                            <div class="row mr-4 mt-4 ml-0" v-if="doublesaving">
                            ...
                            <br>
                        <button v-if="!isloading && success!='' && motorcycle" class="btn btn-block cta-button mt-4" @click="navigate()">Continue</button>
                        <button v-if="!isloading && success!='' && cashprize" class="btn btn-block cta-button mt-4" @click="navigate_cashprize()">Continue</button>
                        <button v-if="!isloading && success!='' && doublesaving" class="btn btn-block cta-button mt-4" @click="navigate_doublesaving()">Continue</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods:{
        ...
        navigate(){
            this.$router.push({name:'monthly-motorcycle-raffle'})
        },
        navigate_cashprize(){
            this.$router.push({name:'monthly-cashprize-raffle'})
        },
        navigate_doublesaving(){
            this.$router.push({name:'monthly-doublesaving-raffle'})
        }
    }
}
</script>

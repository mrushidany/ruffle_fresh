            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body jackpot-modal-content">
                        <p class="title">Cash Prize</p>
                        <img :src="'../images/weekly_cash.png'" style="height:190px;width:auto;object-fit:contain;">
                        <p class="winner">50 - winners !</p>
